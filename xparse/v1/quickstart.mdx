...
<CardGroup cols={2}>
  ...
  <Card title="引擎可替换" icon="arrows-rotate">
    支持多种解析引擎（TextIn、MinerU、PaddleOCR 和 GUI），可根据场景选择最优引擎，或对比不同引擎效果。
  </Card>
...
<Tip>
  **新增 GUI 识别引擎，精准解析界面元素**
  ...
  ![GUI 引擎解析效果示例](https://web-api.textin.com/open/image/download?filename=586d64e8cb084f3990640649fad7f2ac)
