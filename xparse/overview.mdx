...
<CardGroup cols={2}>
  <Card title="在线 Web 平台" icon="sparkles" href="https://www.textin.com/console/recognition/robot_markdown?service=pdf_to_markdown">
    免费试用，一站式极速体验解析抽取效果
  </Card>
  <Card title="API" icon="sparkles" href="/api-reference">
    灵活使用不同编程语言，支持接口高度自定义
  </Card>
  <Card title="CLI & SDK" icon="sparkles" href="/xparse/v1/cli">
    提供可直接复制运行的命令行工具与 SDK，快速将 xParse 文档解析能力集成到开发环境中
  </Card>
  <Card title="第三方 Agent/RAG 平台" icon="sparkles" href="/xparse/v1/ecosystem/skills-mcp">
