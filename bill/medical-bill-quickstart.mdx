...
<Tip>
  本教程基于python示例分步讲解如何使用国内通用票据识别/医疗票据识别API。我们另外提供了完整的多语言示例代码和在线快捷调试功能，请参考[Textin文档中心](https://www.textin.com/document/bill_recognize_v2)。
</Tip>
...
您可以参考以下示例文件和步骤，快速验证并将医疗票据API接入到您的系统和应用流程中。

![Quick start 1](/images/bill-quickstart-1.webp)  ![Quick start 2](/images/bill-quickstart-2.webp)
