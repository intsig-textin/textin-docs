...
### 4.1 页面布局与样式
- [x] 页面包含所有四个板块（Skills & MCP、CLI/SDK、RAG 与 Agent 框架、API 文档）
- [x] 使用卡片网格展示平台和框架
- [x] 页面风格与现有文档页面一致

### 4.2 Skills & MCP 板块
- [x] 展示 4 个资源下载链接，每个链接有复制和跳转功能
- [x] 展示 8 个官方平台集成卡片，标题、副标题、描述完整
- [x] MCP Server 配置代码块正确，教程链接可跳转

### 4.3 CLI/SDK 板块
- [x] xParser CLI 安装命令（Linux/macOS、Windows）正确
- [x] 快速开始代码示例完整，教程链接可跳转
- [x] Python SDK 代码示例完整，教程链接可跳转
- [x] REST API 同步/异步代码示例完整，教程链接可跳转

### 4.4 RAG 与 Agent 框架板块
- [x] 展示 5 个主要框架（LangChain、Dify、RAGFlow、Coze、Cherry Studio）
- [x] 每个框架的链接（GitHub、PyPI、插件下载等）可正常跳转
- [x] 兼容框架列表展示完整

### 4.5 所有代码块
- [x] 每个代码块有语法高亮
- [x] 代码块右上角有复制按钮（Mintlify 默认）
- [x] 点击复制按钮后可正确复制内容
